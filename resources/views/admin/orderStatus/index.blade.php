		...
		<form class="layui-form" action="{{ Request::getRequestUri() }}">
			<div class="layui-form-item">
    			...
    			<div class="layui-inline">
					...
					{!! App\Lib\Ehtml::select(App\Models\OrderStatusType::getList(true),$model->order_status_type_id,['name'=>'order_status_type_id','id'=>'order_status_type_id','lay-filter'=>'order_status_type_id','class'=>'form-control']) !!}
					</div>
				</div>
...
<div class="my-btn-box">
	<span class="fl">
		...
		<a class="layui-btn btn-add btn-default layui-btn-sm" id="btn-add" href="{{ URL('admin/orderStatus/create') }}">添加</a>
...
,{field: "sort", title: "{{ $model->labels["sort"] }}",  sort: true}
	...
	$("#btn-delete-all").on("click", function () {
		...
		$.ajax({ 
			type: "GET",
			url: "{{URL("admin/orderStatus/ajaxDestroy")}}/"+ids, 
			dataType: "json",
			success: function(data){
				if(data.code=="000")
				{
