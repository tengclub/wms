...
<div class="my-btn-box">
	<span class="fl">
	 	<a class="layui-btn layui-btn-primary layui-btn-sm" href="{{ URL('admin/whItems/index') }}">返回</a>
...
layui.use("table", function(){
	...
	var tableIns = table.render({ //其它参数在此省略
		...
		, cols: [[ 
{field: "warehouse_text", title: "{{ $model->labels["warehouse_id"] }}",width: 150, sort: true}
,{field: "wh_area_text", title: "{{ $model->labels["wh_area_id"] }}",width: 80 , sort: true}
,{field: "wh_shelf_text", title: "{{ $model->labels["wh_shelf_id"] }}",width: 80,  sort: true}
