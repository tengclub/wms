...
class KindEditorController extends Controller
{
    ...
    function __construct() {
    	 $this->_uploadPath = public_path('uploads/editor/');
    	 $this->_uploadUrl = asset('uploads/editor').'/';
    }
     ...
     */
    public function fileManageerJson()
    {
    	
        //根目录路径，可以指定绝对路径，比如 /var/www/attached/
        $root_path = public_path('uploads/editor/');
        //根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
        $root_url = asset('uploads/editor').'/';
    ...
    {
        //文件保存目录路径
        $save_path = public_path('uploads/editor/');
        //文件保存目录URL
        $save_url = asset('uploads/editor').'/';
        //定义允许上传的文件扩展名
        $ext_arr = array(
